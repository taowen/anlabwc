...
write_embed_rc(const char *runtime_dir)
{
	...
	fputs(
		...
		"  </mouse>\n"
		"  <windowRules>\n"
		"    <windowRule title=\"bionic-gles-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"16\" y=\"16\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"bionic-vk-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"600\" y=\"16\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"gladio-wayland-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"1184\" y=\"16\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"vortek-wayland-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"1768\" y=\"16\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"gladio-x11-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"16\" y=\"548\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"vortek-x11-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"600\" y=\"548\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"freedreno-x11-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"1184\" y=\"548\" />\n"
		"    </windowRule>\n"
		"    <windowRule title=\"turnip-x11-fps teapot\">\n"
		"      <action name=\"MoveTo\" x=\"1768\" y=\"548\" />\n"
		"    </windowRule>\n"
		"  </windowRules>\n"
		"</labwc_config>\n", f);
	fclose(f);
